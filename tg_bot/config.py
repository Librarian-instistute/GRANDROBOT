...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "--"
    OWNER_ID = "1711642802"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "Mr_Purushottam_M"

    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'sqldbtype://username:pw@hostname:port/db_name'  # needed for any database modules
    MESSAGE_DUMP = None  # needed to make sure 'save from' messages persist
    GBAN_LOGS = -1001133690592 #Channel ID here with -
    LOAD = []
